...
if model_choice == "7B":
    config_file = "flamingo-llama2-chat-7B.json"
    state_dict_files = [
...
# AZP = "os.environ["AZP"]"
#AZP = os.environ["AZP"]
state_dict_3 = torch.load(f"/root/openflamingo-9b-hf/pytorch_model-00004-of-00004.bin", map_location="cpu")
...
print(len(model.text_tokenizer))
model.lang_encoder.resize_token_embeddings(32000)
#model.lang_encoder.resize_token_embeddings(len(model.text_tokenizer), pad_to_multiple_of=8)
