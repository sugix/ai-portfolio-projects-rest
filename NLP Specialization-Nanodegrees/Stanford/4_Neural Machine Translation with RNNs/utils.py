...
def pad_sents(sents, pad_token):
    ...
    # Calculate maximum length from all sentences
    maximum_length = max([len(sentence) for sentence in sents])

    ## Iterate all sentence, calculate padding length and append pad token

    for sentence in sents:
        to_be_padded_len = maximum_length - len(sentence)
        sents_padded.append(sentence + [pad_token] * to_be_padded_len)
    ### END CODE HERE
